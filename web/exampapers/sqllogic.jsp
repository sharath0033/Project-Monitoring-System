...
<%@ page language="java" import="java.sql.*"%>
    ...
    <%
        try{
            ...
            st.executeUpdate("CREATE TABLE IF NOT EXISTS project.sqlanswers (Q_No INT, answer VARCHAR(2), PRIMARY KEY (Q_No), UNIQUE INDEX Q_No_UNIQUE (Q_No ASC))");
            ...
            ResultSet rs=st.executeQuery("SELECT * FROM sqlanswers");
		...
		a[i]=(request.getParameter("q"+i));
            ...
            String qry= "INSERT INTO resultstudent VALUES('"+htno+"','SQL-Paper','10',"+cnt+",'"+grade+"')";
