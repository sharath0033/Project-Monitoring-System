...
<html lang="en">
    <head>
        ...
        <title>Project Team's Report Page</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li class="active" style="padding:5px"><a href="../reports/projectteam.jsp"><span class="glyphicon glyphicon-wrench"></span> Project Team Allocation Report</a></li>
