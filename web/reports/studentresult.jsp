...
<html lang="en">
    ...
    <body id="myPage">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li class="active" style="padding:5px"><a href="../reports/studentresult.jsp"><span class="glyphicon glyphicon-pencil"></span> Student Exam Report</a></li> 
        ...
        <div id="container" class="container slide" >
            <div class="hed">
                <h2>Student Exam Result Report</h2>
            </div>
        ...
        ResultSet rs3=st3.executeQuery("SELECT * FROM resultstudent ");
        while(rs3.next())
        {%>
            <tr>
