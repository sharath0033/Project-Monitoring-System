...
<html lang="en">
    <head>
        ...
        <title>PassedOut Batch Project's Report Page</title>
    ...
    <body id="myPage">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li class="active" style="padding:5px"><a href="../reports/passedoutprojects.jsp"><span class="glyphicon glyphicon-calendar"></span> PassedOut Batch Project Report</a></li>
                                </ul>
                            </li>
                </ul>
        ...
        <div id="container" class="container slide" >
            <div class="hed">
                <h2>PassedOut Batch Project's Report</h2>
            </div>
