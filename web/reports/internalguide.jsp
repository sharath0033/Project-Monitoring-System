...
<html lang="en">
    <head>
        ...
        <title>Internal Guide Registration Report Page</title>
    ...
    <body id="myPage">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                  <li class="active" style="padding:5px"><a href="../reports/internalguide.jsp"><span class="glyphicon glyphicon-briefcase"></span> Internal Guide Registration Report</a></li>
        ...
        <div id="container" class="container slide" >
            <div class="hed">
                <h2>Internal Guide Registration Report</h2>
            </div>
        ...
        ResultSet rs3=st3.executeQuery("SELECT * FROM guideregister ");
        while(rs3.next())
        {%>
            <tr>
